...
def _d4_niche_forward(rot: int, fx: bool, fy: bool) -> Dict[str, str]:
    ...
    from yi_halfwidth import variant_matrix
...
def add_mark_d4_composites(
    ...
    *,
    ...
    from yi_halfwidth import SIDEWAYS_FROM_R90, make_composite_variant
...
def add_squish_forms(
    ...
    *,
    ...
    """
    from yi_halfwidth import contour_center, make_composite_variant
...
def install_cjk_composition_gsub(
    ...
    *,
    ...
    from yi_halfwidth import build_chunked_ligature_subst_lookup
